            ...
            <div id="wpl_searchwidget_<?php echo esc_attr($widget_id); ?>" class="clearfix">
                ...
                <div class="wpl_search_from_box_top">
                    ...
                    <?php if($this->show_reset_button): ?>
                        <div class="wpl_search_reset" onclick="wpl_do_reset<?php echo esc_attr($this->widget_id); ?>([], <?php echo ($this->ajax == 2 ? 'true' : 'false'); ?>);" id="wpl_search_reset<?php echo esc_attr($widget_id); ?>"></div>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
					<?php if((wpl_global::check_addon('save_searches') and wpl_global::get_setting('ss_button_status') ) || wpl_global::check_addon('pro') and wpl_global::get_setting('listings_rss_enabled')): ?>
